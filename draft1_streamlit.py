...
- In your next message, ask directly whether they are currently injured or whether it has healed, with a parenthetical inviting them to say what the injury is if they're comfortable. Establish the injury within the first three exchanges, before asking about their data or feelings in any depth.
...
- "Are you currently injured, or has it fully healed at this point? (If you're comfortable, please describe the injury.)"
...
# Once the session has ended, show the download button right away at the top,
